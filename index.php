<!-- TODO:
create_list: find out way to show progress of complete transfer
create_list: fix 30s execution time fatal error

general: basic interface with dynamic paths
!-->
